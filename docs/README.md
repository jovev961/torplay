...
- [Linux AppImage](linux-deployment.md) — Ubuntu 24.04 x86_64 download, verification, launch, Quit, storage, and troubleshooting.
...
- [Development](development.md) — local prerequisites, setup, commands, data, checks, and workflow.
- [Architecture](architecture.md) — security boundary, components, data flow, project structure, and runtime lifecycle.
- [Features and API](features-and-api.md) — current product behavior and reusable server endpoints.
