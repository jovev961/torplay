export const SETTINGS_PROVIDERS = [
  ...
  },
  {
    ...
    name: "Jackett",
    required: false,
    description: "Optional external Torznab service. Add its configured indexers individually under Torrent Sources.",
    helpUrl: "https://github.com/Jackett/Jackett",
    helpText: "Run Jackett yourself, then enter its base URL and API key. TorPlay does not manage the service.",
    fields: [
      { id: "url", environment: "JACKETT_URL", label: "Base URL", kind: "url", required: true },
  ...
  },
  {
    ...
    name: "Watch Together",
    required: false,
    description: "Connects separate TorPlay installations for private peer-to-peer playback synchronization.",
    helpUrl: "https://github.com/jovev961/torplay/blob/develop/docs/watch-together.md",
    helpText: "Deploy the bundled signaling service over HTTPS, then enter its public base URL.",
    fields: [
      { id: "url", environment: "WATCH_TOGETHER_SIGNAL_URL", label: "Signaling service URL", kind: "url" },
    ],
  },
  {
    id: "opensubtitles",
