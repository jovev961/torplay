...
import { jackettIsConfigured, providerIds } from "../search/provider-config.js";
...
function torrentSourceState(environment) {
  return {
    ...
    jackettActive: jackettIsConfigured(environment)
      && (environment.TORPLAY_SEARCH_PROVIDERS === undefined || providerIds(environment.TORPLAY_SEARCH_PROVIDERS).includes("jackett")),
