...
export const UNAVAILABLE_ACTIONS = ["ask", "local", "remote"];
...
export async function readDebridConfig(options = {}) {
  try {
    ...
    return {
      ...
      unavailableAction: UNAVAILABLE_ACTIONS.includes(raw.unavailableAction)
        ? raw.unavailableAction : defaults.unavailableAction,
